		...
		$.get("http://crossorigin.me/http://eztvapi.re/shows/"+page, function (data) {
			...
			$.each(data, function (i, movie) {
				...
				*/
				...
				html+='<div style="width: 100%; height: 300px; position: absolute; -webkit-filter: blur(3px); background-image:url(http://crossorigin.me/'+movie.images.fanart+'); background-position: center; background-size: cover;  background-repeat: no-repeat;"></div>';
