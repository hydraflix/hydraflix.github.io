		...
		$.get("http://crossorigin.me/http://eztvapi.re/shows/"+page, function (data) {
			...
			$.each(data, function (i, movie) {
				...
				*/
				...
				BLUR!!!
				*/
				html+='<div id="movie-box-'+'" class="movie-box-'+' col-lg-3 col-md-4 col-sm-6 col-xs-12" style="position:relative;float:left;">';
				html+='<div class="movie-box" style="width: 100%; height: 300px; position: absolute; -webkit-filter: blur(3px); background-image:url(http://crossorigin.me/'+movie.images.fanart+'); background-position: center; background-size: cover;  background-repeat: no-repeat;"></div>';
