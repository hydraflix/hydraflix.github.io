	...
	function loadMore() {
		...
		$.get("http://crossorigin.me/http://eztvapi.re/shows/"+page, function (data) {
			...
			$.each(data, function (i, movie) {
				...
				html+='<div id="movie-box-'+'" class="movie-box movie-box-'+' col-lg-3 col-md-4 col-sm-6 col-xs-12" style="background-image:url('+movie.images.fanart+');background-position:center;background-size:cover;background-repeat:no-repeat;position:relative;float:left;"><img id="img-movie-box-'+'" class="hover-luz" title="'+'" alt="'+'" src="'+movie.images.poster+'" style="width: 100%; max-width: 180px; position: relative;" onmouseover="hoverHash(&#39;'+'&#39;)" onmouseout="outHash(&#39;'+'&#39;)" onclick="f_play_detalle(&#39;'+'&#39;,&#39;'+'&#39;,&#39;'+'&#39;,&#39;'+'&#39;,&#39;'+'&#39;); scrollDetails(&#39;'+'&#39;);"/><div id="movie-rating-star-'+'" class="movie_rating_star">'+'</div></div>';
