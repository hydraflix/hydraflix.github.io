	...
	function loadMore() {
		...
		$.get("http://crossorigin.me/http://eztvapi.re/shows/"+page, function (data) {
			...
			$.each(data, function (i, movie) {			
				...
				html+='<img id="img-movie-box-'+'" class="hover-luz" title="'+'" alt="'+'" src="http://crossorigin.me/'+movie.images.poster+'" style="width: 100%; max-width: 180px; height: 270px; position: relative;" onmouseover="hoverHash(&#39;'+movie.imdb_id+'&#39;)" onmouseout="outHash(&#39;'+movie.imdb_id+'&#39;)" onclick="f_play_detalle(&#39;'+'&#39;,&#39;'+'&#39;,&#39;'+'&#39;,&#39;'+'&#39;,&#39;'+'&#39;); scrollDetails(&#39;'+'&#39;);"/><div id="movie-rating-star-'+movie.imdb_id+'" class="movie_rating_star"></div></div>';
				...
				$.get("http://www.omdbapi.com/?i="+movie.imdb_id+"&plot=full&r=json", function (data) {
					...
					$("#movie-rating-star-"+imdbID).html(html_rating);
					console.log("#movie-rating-star-+imdb: "+"#movie-rating-star-"+imdbID);
				});				
				i++;
			});	
			page=page++;
