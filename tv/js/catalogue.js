		...
		request.onreadystatechange = function () {
		  if (this.readyState === 4) {
		    ...
		    $.each(data, function (i, movie) {
				...
				*/
				html+='<div id="movie-box-'+movie.ids.imdb+'" class="movie-box col-lg-3 col-md-4 col-sm-6 col-xs-12" style="background-image:url('+(movie.images.fanart.thumb).replace("https", "http")+');background-position:center;background-size:cover;background-repeat:no-repeat;position:relative;float:left;"><img id="img-movie-box-'+movie.ids.imdb+'" class="hover-luz" title="'+movie.title+'" alt="'+movie.title+'" src="'+(movie.images.poster.thumb).replace("https", "http")+'" style="width: 100%; max-width: 180px; position: relative;" onmouseover="hoverHash(&#39;&#39;)" onmouseout="outHash(&#39;&#39;)" onclick="f_play_detalle(&#39;&#39;,&#39;&#39;,&#39;&#39;,&#39;&#39;,&#39;&#39;); scrollDetails(&#39;&#39;);"/><div id="movie-rating-star-'+movie.ids.imdb+'" class="movie_rating_star"></div></div>';
